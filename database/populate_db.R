...
('On average, participants spend XX days from project entry to residential move-in', NULL, 'On average, participants are placed in housing <<goal>> after referral to RRH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '15 days', 30, 'orr_service@abtglobal.com'),
('On average, participants spend XX days from project entry to residential move-in', NULL, 'On average, participants are placed in housing <<goal>> after referral to RRH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '15 days', 30, 'orr_service@abtglobal.com'),
('On average, participants stay in project XX days', NULL, 'On average, participants stay in project <<goal>>', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '180 days', 20, 'orr_service@abtglobal.com'),
('On average, participants stay in project XX days', NULL, 'On average, participants stay in project <<goal>>', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '180 days', 20, 'orr_service@abtglobal.com'),
('On average, participants stay in project XX days', NULL, 'On average, participants stay in project <<goal>>', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '180 days', 10, 'orr_service@abtglobal.com'),
('On average, participants stay in project XX days', NULL, 'On average, participants stay in project <<goal>>', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '180 days', 10, 'orr_service@abtglobal.com'),
('On average, participants spend XX days from project entry to residential move-in', NULL, 'On average, participants are placed in housing <<goal>> after referral to RRH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_los_renew), '15 days', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent move to permanent housing', NULL, '<<goal>> move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent move to permanent housing', NULL, '<<goal>> move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '80 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent remain in or move to permanent housing', NULL, '<<goal>> remain in or move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent remain in or move to permanent housing', NULL, '<<goal>> remain in or move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent move to permanent housing', NULL, '<<goal>> move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent move to permanent housing', NULL, '<<goal>> move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent move to permanent housing', NULL, '<<goal>> move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
('Minimum percent move to permanent housing', NULL, '<<goal>> move to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_exits_ph_renew), '90 %', 25, 'orr_service@abtglobal.com'),
...
('Maximum percent of participants return to homelessness within 12 months of exit to permanent housing', 'Within 12 months of exit to permanent housing', '≤ <<goal>> of participants return to homelessness within 12 months of exit to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_returns_homeless_renew), '20 %', 10, 'orr_service@abtglobal.com'),
...
('Maximum percent of participants return to homelessness within 12 months of exit to permanent housing', 'Within 12 months of exit to permanent housing', '≤ <<goal>> of participants return to homelessness within 12 months of exit to PH', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_returns_homeless_renew), '20 %', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased earned income for project stayers', 'Earned income for project stayers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '8 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased earned income for project stayers', 'Earned income for project stayers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '8 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased non-employment income for project stayers', 'Non-employment income for project stayers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '10 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased non-employment income for project stayers', 'Non-employment income for project stayers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '10 %', 2.5, 'orr_service@abtglobal.com'),
('Minimum percent of participants with new or increased non-employment income for project stayers', 'Non-employment income for project stayers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '10 %', 2.5, 'orr_service@abtglobal.com'),
('Minimum percent of participants with new or increased non-employment income for project stayers', 'Non-employment income for project stayers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '10 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased earned income for project leavers', 'Earned income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '15 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased earned income for project leavers', 'Earned income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '15 %', 2.5, 'orr_service@abtglobal.com'),
('Minimum percent of participants with new or increased earned income for project leavers', 'Earned income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '15 %', 2.5, 'orr_service@abtglobal.com'),
('Minimum percent of participants with new or increased earned income for project leavers', 'Earned income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '15 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased non-employment income for project leavers', 'Non-employment income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '25 %', 2.5, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with new or increased non-employment income for project leavers', 'Non-employment income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '25 %', 2.5, 'orr_service@abtglobal.com'),
('Minimum percent of participants with new or increased non-employment income for project leavers', 'Non-employment income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '25 %', 2.5, 'orr_service@abtglobal.com'),
('Minimum percent of participants with new or increased non-employment income for project leavers', 'Non-employment income for project leavers', '<<goal>>+ of participants with new or increased income', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_perf_meas_renew), (SELECT factor_subgroup_id FROM fsg_new_inc_income_renew), '25 %', 2.5, 'orr_service@abtglobal.com'),
...
('Assessment score for XX% of participants indicates RRH or more intensive intervention', NULL, 'Assessment score for <<goal>> of participants indicates RRH or more intensive intervention', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_coord_assess_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('Assessment score for XX% of participants indicates RRH or more intensive intervention', NULL, 'Assessment score for <<goal>> of participants indicates RRH or more intensive intervention', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_coord_assess_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('Assessment score for participants indicates PSH with XX% at highest end of PSH range', NULL, 'Assessment score for participants indicates PSH with <<goal>> at highest end of PSH range', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_coord_assess_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('Assessment score for participants indicates PSH with XX% at highest end of PSH range', NULL, 'Assessment score for participants indicates PSH with <<goal>> at highest end of PSH range', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_coord_assess_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('XX% of participant meet CoC''s TH targeting criteria', NULL, '<<goal>> of participants meet CoC’s TH targeting criteria', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_coord_assess_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('XX% of participant meet CoC''s TH targeting criteria', NULL, '<<goal>> of participants meet CoC’s TH targeting criteria', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_coord_assess_renew), '95 %', 20, 'orr_service@abtglobal.com'),
...
('XX% of participants are chronically homeless', NULL, '≥ <<goal>> of participants are chronically homeless', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_proj_chron_homeless_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('XX% of participants are chronically homeless', NULL, '≥ <<goal>> of participants are chronically homeless', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_proj_chron_homeless_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('XX% of participants are chronically homeless', NULL, '≥ <<goal>> of participants are chronically homeless', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_proj_chron_homeless_renew), '95 %', 20, 'orr_service@abtglobal.com'),
('XX% of participants are chronically homeless', NULL, '≥ <<goal>> of participants are chronically homeless', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_proj_chron_homeless_renew), '95 %', 20, 'orr_service@abtglobal.com'),
...
('XX% of participants are chronically homeless', NULL, '≥ <<goal>> of participants are chronically homeless', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_proj_chron_homeless_renew), '95 %', 20, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with zero income at entry', NULL, '≥ <<goal>> of participants with zero income at entry', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants with zero income at entry', NULL, '≥ <<goal>> of participants with zero income at entry', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants with more than one disability', NULL, '≥ <<goal>> of participants with more than one disability type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants with more than one disability', NULL, '≥ <<goal>> of participants with more than one disability type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with zero income at entry', NULL, '≥ <<goal>> of participants with zero income at entry', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '80 %', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with more than one disability', NULL, '≥ <<goal>> of participants with more than one disability type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '75 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '75 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '75 %', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with zero income at entry', NULL, '≥ <<goal>> of participants with zero income at entry', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with more than one disability', NULL, '≥ <<goal>> of participants with more than one disability type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
...
('Minimum percent of participants with more than one disability', NULL, '≥ <<goal>> of participants with more than one disability type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
('Minimum percent of participants entering project from place not meant for human habitation', NULL, '≥ <<goal>> of participants entering project from place not meant for human habitation', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th_rrh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_high_needs_renew), (SELECT factor_subgroup_id FROM fsg_apr_data_renew), '50 %', 10, 'orr_service@abtglobal.com'),
...
('Costs are within local average cost per positive housing exit for project type', 'Project has reasonable costs', 'Costs are within local average cost per positive housing exit for project type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_renew), NULL, 'Yes', 10, 'orr_service@abtglobal.com'),
...
('Costs are within local average cost per positive housing exit for project type', 'Project has reasonable costs', 'Costs are within local average cost per positive housing exit for project type', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_renew), NULL, 'Yes', 10, 'orr_service@abtglobal.com'),
...
('Coordinated Entry Participation- Minimum percent of entries to project from CE referral (or alternative system for DV projects)', 'Coordinated Entry Participation', '≥ <<goal>> of entries to project from CE referrals', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_renew), NULL, '95 %', 10, 'orr_service@abtglobal.com'),
...
('Coordinated Entry Participation- Minimum percent of entries to project from CE referral (or alternative system for DV projects)', 'Coordinated Entry Participation', '≥ <<goal>> of entries to project from CE referrals', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_renew), NULL, '95 %', 10, 'orr_service@abtglobal.com'),
...
('Housing First and/or Low Barrier Implementation - CoC assessment of fidelity to Housing First from CoC monitoring or review of project policies and procedures', 'Housing First and/or Low Barrier Implementation', 'Commits to applying Housing First model', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_psh), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_renew), NULL, 'Yes', 10, 'orr_service@abtglobal.com'),
...
('Housing First and/or Low Barrier Implementation - CoC assessment of fidelity to Housing First from CoC monitoring or review of project policies and procedures', 'Housing First and/or Low Barrier Implementation', 'Commits to applying Housing First model', (SELECT reference_id FROM l_renew), (SELECT reference_id FROM l_th), (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_renew), NULL, 'Yes', 10, 'orr_service@abtglobal.com'),
...
('A. Describe the experience of the applicant and sub-recipients (if any) in working with the proposed population and in providing housing similar to that proposed in the application.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 15, 'orr_service@abtglobal.com'),
...
- Process and criteria for exiting clients
- Demonstration of no preconditions to entry, allowing entry regardless of current or past substance abuse, income, criminal records (with exceptions of restrictions imposed by federal, state, or local law or ordinance), marital status, familial status, self-disclosed or perceived sexual orientation, gender identity or gender expression.
- Demonstration that the project has a process to address situations that may jeopardize housing or project assistance to ensure that project participation is terminated in only the most severe cases.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
...
('C. Describe experience in effectively utilizing federal funds including HUD grants and other public funding, including satisfactory drawdowns and performance for existing grants as evidenced by timely reimbursement of subrecipients (if applicable), regular drawdowns, timely resolution of monitoring findings, and timely submission of required reporting on existing grants.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('A. Extent to which the applicant 1) Demonstrates understanding of the needs of the clients to be served. 2) Demonstrates that type, scale, and location of the housing fit the needs of the clients to be served. 3) Demonstrates that type and scale of the all supportive services, regardless of funding source, meets the needs of clients to be served. 4) Demonstrates how clients will be assisted in obtaining mainstream benefits. 5) Establishes performances measures for housing and income that are objective, measurable, trackable and meet or exceed any established HUD or CoC benchmarks.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 15, 'orr_service@abtglobal.com'),
...
('B. Describe the plan to assist clients to rapidly secure and maintain permanent housing that is safe, affordable, accessible, and acceptable to their needs.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('C. Describe how clients will be assisted to increase employment and/or income and to maximize their ability to live independently.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('D. Project leverages housing resources with housing subsidies or units not funded through the CoC or ESG programs.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
...
('E. Project leverages health resources, including a partnership commitment with a healthcare organization.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
...
('A. Describe plan for rapid implementation of the program, documenting how the project will be ready to begin housing the first program participant. Provide a detailed schedule of proposed activities for 60 days, 120 days, and 180 days after grant award.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_timeliness_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
...
('A. Project is cost-effective when projected cost per person served is compared to CoC average within project type.', NULL, (SELECT reference_id FROM l_new), NULL, NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('B1. Organization''s most recent audit: Found no exceptions to standard practices', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('B2. Organization''s most recent audit: Identified agency as ''low risk''', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('B3. Organization''s most recent audit: Indicates no findings', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('C. Documented match amount meets HUD requirements.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
...
('D. Budgeted costs are reasonable, allocable, and allowable.', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 20, 'orr_service@abtglobal.com'),
...
('Coordinated Entry Participation- Minimum percent of entries projected to come from CE referrals', NULL, NULL, (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_hic), (SELECT factor_group_id FROM fg_proj_effect_new), NULL, '95 %', 5, 'orr_service@abtglobal.com');
