...
CREATE TABLE coc_versions (
    ...
    coc VARCHAR(6) REFERENCES cocs(coc_code) ON DELETE CASCADE,
    coc_status SMALLINT DEFAULT __NOT_STARTED__ REFERENCES lookups(reference_id), -- default to Not Started
    date_created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    created_by VARCHAR(100) REFERENCES users(username) ON DELETE CASCADE,
    date_updated TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_by VARCHAR(100) NULL REFERENCES users(username) ON DELETE CASCADE,
...
('A. Describe the experience of the applicant and sub-recipients (if any) in working with the proposed population and in providing housing similar to that proposed in the application.', NULL, 'A. Describe the experience of the applicant and sub-recipients (if any) in working with the proposed population and in providing housing similar to that proposed in the application.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 15, 'orr_service@abtglobal.com'),
('A. Describe the experience of the applicant and sub-recipients (if any) in working with the proposed population and in providing housing similar to that proposed in the application.', NULL, 'A. Describe the experience of the applicant and sub-recipients (if any) in working with the proposed population and in providing housing similar to that proposed in the application.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 15, 'orr_service@abtglobal.com'),
('B. Describe experience with utilizing a Housing First approach. This must include:<ul><li>Eligibility criteria</li><li>Process for accepting new clients</li><li>Process and criteria for exiting clients</li><li>Demonstration of no preconditions to entry, allowing entry regardless of current or past substance abuse, income, criminal records (with exceptions of restrictions imposed by federal, state, or local law or ordinance), marital status, familial status, self-disclosed or perceived sexual orientation, gender identity or gender expression.</li><li>Demonstration that the project has a process to address situations that may jeopardize housing or project assistance to ensure that project participation is terminated in only the most severe cases.</li></ul>', NULL, 'B. Describe experience with utilizing a Housing First approach. This must include:<ul><li>Eligibility criteria</li><li>Process for accepting new clients</li><li>Process and criteria for exiting clients</li><li>Demonstration of no preconditions to entry, allowing entry regardless of current or past substance abuse, income, criminal records (with exceptions of restrictions imposed by federal, state, or local law or ordinance), marital status, familial status, self-disclosed or perceived sexual orientation, gender identity or gender expression.</li><li>Demonstration that the project has a process to address situations that may jeopardize housing or project assistance to ensure that project participation is terminated in only the most severe cases.</li></ul>', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
('B. Describe experience with utilizing a Housing First approach. This must include:<ul><li>Eligibility criteria</li><li>Process for accepting new clients</li><li>Process and criteria for exiting clients</li><li>Demonstration of no preconditions to entry, allowing entry regardless of current or past substance abuse, income, criminal records (with exceptions of restrictions imposed by federal, state, or local law or ordinance), marital status, familial status, self-disclosed or perceived sexual orientation, gender identity or gender expression.</li><li>Demonstration that the project has a process to address situations that may jeopardize housing or project assistance to ensure that project participation is terminated in only the most severe cases.</li></ul>', NULL, 'B. Describe experience with utilizing a Housing First approach. This must include:<ul><li>Eligibility criteria</li><li>Process for accepting new clients</li><li>Process and criteria for exiting clients</li><li>Demonstration of no preconditions to entry, allowing entry regardless of current or past substance abuse, income, criminal records (with exceptions of restrictions imposed by federal, state, or local law or ordinance), marital status, familial status, self-disclosed or perceived sexual orientation, gender identity or gender expression.</li><li>Demonstration that the project has a process to address situations that may jeopardize housing or project assistance to ensure that project participation is terminated in only the most severe cases.</li></ul>', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
('C. Describe experience in effectively utilizing federal funds including HUD grants and other public funding, including satisfactory drawdowns and performance for existing grants as evidenced by timely reimbursement of subrecipients (if applicable), regular drawdowns, timely resolution of monitoring findings, and timely submission of required reporting on existing grants.', NULL, 'C. Describe experience in effectively utilizing federal funds including HUD grants and other public funding, including satisfactory drawdowns and performance for existing grants as evidenced by timely reimbursement of subrecipients (if applicable), regular drawdowns, timely resolution of monitoring findings, and timely submission of required reporting on existing grants.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('C. Describe experience in effectively utilizing federal funds including HUD grants and other public funding, including satisfactory drawdowns and performance for existing grants as evidenced by timely reimbursement of subrecipients (if applicable), regular drawdowns, timely resolution of monitoring findings, and timely submission of required reporting on existing grants.', NULL, 'C. Describe experience in effectively utilizing federal funds including HUD grants and other public funding, including satisfactory drawdowns and performance for existing grants as evidenced by timely reimbursement of subrecipients (if applicable), regular drawdowns, timely resolution of monitoring findings, and timely submission of required reporting on existing grants.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_experience_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),

-- Design of Housing & Supportive Services (factor_group = fg_design_housing_new)
('A. Extent to which the applicant 1) Demonstrates understanding of the needs of the clients to be served. 2) Demonstrates that type, scale, and location of the housing fit the needs of the clients to be served. 3) Demonstrates that type and scale of the all supportive services, regardless of funding source, meets the needs of clients to be served. 4) Demonstrates how clients will be assisted in obtaining mainstream benefits. 5) Establishes performances measures for housing and income that are objective, measurable, trackable and meet or exceed any established HUD or CoC benchmarks.', NULL, 'A. Extent to which the applicant 1) Demonstrates understanding of the needs of the clients to be served. 2) Demonstrates that type, scale, and location of the housing fit the needs of the clients to be served. 3) Demonstrates that type and scale of the all supportive services, regardless of funding source, meets the needs of clients to be served. 4) Demonstrates how clients will be assisted in obtaining mainstream benefits. 5) Establishes performances measures for housing and income that are objective, measurable, trackable and meet or exceed any established HUD or CoC benchmarks.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 15, 'orr_service@abtglobal.com'),
('A. Extent to which the applicant 1) Demonstrates understanding of the needs of the clients to be served. 2) Demonstrates that type, scale, and location of the housing fit the needs of the clients to be served. 3) Demonstrates that type and scale of the all supportive services, regardless of funding source, meets the needs of clients to be served. 4) Demonstrates how clients will be assisted in obtaining mainstream benefits. 5) Establishes performances measures for housing and income that are objective, measurable, trackable and meet or exceed any established HUD or CoC benchmarks.', NULL, 'A. Extent to which the applicant 1) Demonstrates understanding of the needs of the clients to be served. 2) Demonstrates that type, scale, and location of the housing fit the needs of the clients to be served. 3) Demonstrates that type and scale of the all supportive services, regardless of funding source, meets the needs of clients to be served. 4) Demonstrates how clients will be assisted in obtaining mainstream benefits. 5) Establishes performances measures for housing and income that are objective, measurable, trackable and meet or exceed any established HUD or CoC benchmarks.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 15, 'orr_service@abtglobal.com'),
('B. Describe the plan to assist clients to rapidly secure and maintain permanent housing that is safe, affordable, accessible, and acceptable to their needs.', NULL, 'B. Describe the plan to assist clients to rapidly secure and maintain permanent housing that is safe, affordable, accessible, and acceptable to their needs.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B. Describe the plan to assist clients to rapidly secure and maintain permanent housing that is safe, affordable, accessible, and acceptable to their needs.', NULL, 'B. Describe the plan to assist clients to rapidly secure and maintain permanent housing that is safe, affordable, accessible, and acceptable to their needs.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('C. Describe how clients will be assisted to increase employment and/or income and to maximize their ability to live independently.', NULL, 'C. Describe how clients will be assisted to increase employment and/or income and to maximize their ability to live independently.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('C. Describe how clients will be assisted to increase employment and/or income and to maximize their ability to live independently.', NULL, 'C. Describe how clients will be assisted to increase employment and/or income and to maximize their ability to live independently.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('D. Project leverages housing resources with housing subsidies or units not funded through the CoC or ESG programs.', NULL, 'D. Project leverages housing resources with housing subsidies or units not funded through the CoC or ESG programs.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
('D. Project leverages housing resources with housing subsidies or units not funded through the CoC or ESG programs.', NULL, 'D. Project leverages housing resources with housing subsidies or units not funded through the CoC or ESG programs.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
('E. Project leverages health resources, including a partnership commitment with a healthcare organization.', NULL, 'E. Project leverages health resources, including a partnership commitment with a healthcare organization.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
('E. Project leverages health resources, including a partnership commitment with a healthcare organization.', NULL, 'E. Project leverages health resources, including a partnership commitment with a healthcare organization.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_design_housing_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),

-- Timeliness (factor_group = fg_timeliness_new)
('A. Describe plan for rapid implementation of the program, documenting how the project will be ready to begin housing the first program participant. Provide a detailed schedule of proposed activities for 60 days, 120 days, and 180 days after grant award.', NULL, 'A. Describe plan for rapid implementation of the program, documenting how the project will be ready to begin housing the first program participant. Provide a detailed schedule of proposed activities for 60 days, 120 days, and 180 days after grant award.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_timeliness_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),
('A. Describe plan for rapid implementation of the program, documenting how the project will be ready to begin housing the first program participant. Provide a detailed schedule of proposed activities for 60 days, 120 days, and 180 days after grant award.', NULL, 'A. Describe plan for rapid implementation of the program, documenting how the project will be ready to begin housing the first program participant. Provide a detailed schedule of proposed activities for 60 days, 120 days, and 180 days after grant award.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_timeliness_new), NULL, NULL, 10, 'orr_service@abtglobal.com'),

-- Financial (factor_group = fg_financial_new)
('A. Project is cost-effective when projected cost per person served is compared to CoC average within project type.', NULL, 'A. Project is cost-effective when projected cost per person served is compared to CoC average within project type.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('A. Project is cost-effective when projected cost per person served is compared to CoC average within project type.', NULL, 'A. Project is cost-effective when projected cost per person served is compared to CoC average within project type.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B1. Organization''s most recent audit: Found no exceptions to standard practices', NULL, 'B1. Organization''s most recent audit: Found no exceptions to standard practices', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B1. Organization''s most recent audit: Found no exceptions to standard practices', NULL, 'B1. Organization''s most recent audit: Found no exceptions to standard practices', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B2. Organization''s most recent audit: Identified agency as ''low risk''', NULL, 'B2. Organization''s most recent audit: Identified agency as ''low risk''', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B2. Organization''s most recent audit: Identified agency as ''low risk''', NULL, 'B2. Organization''s most recent audit: Identified agency as ''low risk''', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B3. Organization''s most recent audit: Indicates no findings', NULL, 'B3. Organization''s most recent audit: Indicates no findings', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('B3. Organization''s most recent audit: Indicates no findings', NULL, 'B3. Organization''s most recent audit: Indicates no findings', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('C. Documented match amount meets HUD requirements.', NULL, 'C. Documented match amount meets HUD requirements.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('C. Documented match amount meets HUD requirements.', NULL, 'C. Documented match amount meets HUD requirements.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 5, 'orr_service@abtglobal.com'),
('D. Budgeted costs are reasonable, allocable, and allowable.', NULL, 'D. Budgeted costs are reasonable, allocable, and allowable.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 20, 'orr_service@abtglobal.com'),
('D. Budgeted costs are reasonable, allocable, and allowable.', NULL, 'D. Budgeted costs are reasonable, allocable, and allowable.', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_financial_new), NULL, NULL, 20, 'orr_service@abtglobal.com'),

-- Project Effectiveness (factor_group = fg_proj_effect_new)
('Coordinated Entry Participation- Minimum percent of entries projected to come from CE referrals', NULL, 'Coordinated Entry Participation- Minimum percent of entries projected to come from CE referrals', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_dv), (SELECT factor_group_id FROM fg_proj_effect_new), NULL, '95 %', 5, 'orr_service@abtglobal.com'),
('Coordinated Entry Participation- Minimum percent of entries projected to come from CE referrals', NULL, 'Coordinated Entry Participation- Minimum percent of entries projected to come from CE referrals', (SELECT reference_id FROM l_new), NULL, (SELECT reference_id FROM l_general), (SELECT factor_group_id FROM fg_proj_effect_new), NULL, '95 %', 5, 'orr_service@abtglobal.com');
...
CREATE TABLE projects (
    ...
    coc_amount_awarded_last_year NUMERIC(12, 2) NULL,
    ...
    amount_other_public_funding NUMERIC(12, 2),
    amount_private_funding NUMERIC(12, 2),
    date_created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    created_by VARCHAR(100) REFERENCES users(username) ON DELETE CASCADE,
    date_updated TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_by VARCHAR(100) NULL REFERENCES users(username) ON DELETE CASCADE,
