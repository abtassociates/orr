...
<template>
  <div>
    ...
    <div class="hud-nav-header flex">
      <div class="hud-nav-image flex-none">
        <a :href="$config.public.hdxBase">
          <img src="/img/hdx_logo_nav_white.png" alt="DHX Homelessness Data Exchange 2.0" />
        </a>
      </div>
