main_nav <- function(user_is_logged_in) {
  # Always show the About tab
  tabs <- list(
    nav_panel(
      title = 'About',
      value = 'about',
      ...
      card(
        ...
        card_body(
          ...
          br(),
          HTML("
            <p>HUD is providing this Rating and Ranking Tool to help CoCs design and implement a comprehensive annual CoC competition application review process. It has several customization features so you can choose the rating factors that are most relevant to your CoC and the priorities your CoC has adopted to inform system (re)design.</p>
  ...
  # Once user logs in, also show dashboard and other app tabs
  if(user_is_logged_in) {
    tabs <- append(tabs, c(
      ...
      lapply(
        TABS_TO_SHOW,
        function(t) get(glue::glue("mod_{t}_ui"))(t)
      )
    ))
  }
